...
# Loading Data
employee_attrition_tbl <- read_csv("C:/Users/Jeevan/OneDrive/Documents/TUHH/Business decision with Machine Learning/Business Decisions with Machine Learning/WA_Fn-UseC_-HR-Employee-Attrition.csv")
definitions_raw_tbl    <- read_excel("C:/Users/Jeevan/OneDrive/Documents/TUHH/Business decision with Machine Learning/Business Decisions with Machine Learning/data_definitions.xlsx", sheet = 1, col_names = FALSE)
...
automl_leader <- h2o.loadModel("C:/Users/Jeevan/OneDrive/Documents/TUHH/Business decision with Machine Learning/Business Decisions with Machine Learning/h20models/StackedEnsemble_AllModels_3_AutoML_2_20230517_140427")
automl_leader
...
explanation <- test_tbl %>%
  ...
  lime::explain(
    ...
    n_labels   = 1,
    # number of features that has to be returned
    n_features = 8,
